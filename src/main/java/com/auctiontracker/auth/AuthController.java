...
public class AuthController {
    ...
    public record MeResponse(boolean authenticated, String username, String displayName,
                             String role, UUID teamId, String teamName, UUID tournamentId,
    ...
    public MeResponse me(Authentication authentication) {
        if (authentication == null || !authentication.isAuthenticated()
            ...
            return new MeResponse(false, null, null, null, null, null, null, java.util.Set.of());
        }
        ...
        return new MeResponse(true, principal.getUsername(), principal.displayName(),
                ...
                principal.tournamentId(), principal.adminTournamentIds());
    }
}
